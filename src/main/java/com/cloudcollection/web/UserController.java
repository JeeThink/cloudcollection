...
import com.cloudcollection.utils.FileUtil;
import com.cloudcollection.utils.MD5Util;
import com.cloudcollection.utils.MessageUtil;
...
public class UserController extends BaseController {
	...
	public Response create(User user) {
		try {
			...
			user.setLastModifyTime(DateUtils.getCurrentDateTime());
